...
a persistence unit "PracticaPrueba1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PracticaPrueba1/pom.xml":
...
artifact ("PracticaPrueba1.war") is already built. You can build
